...
//public class ImThirdPerson : MonoBehaviour
//{
...
//        follow = followXform.GetComponent<StagMovement>();
...
//    void LateUpdate()
//    {
//        viewFrustum = DebugDraw.CalculateViewFrustum(m_Camera, ref nearClipDimensions);
...
//            // * First Person *
//            if (rightY > firstPersonThreshold && camState != CamStates.Free)
//            {
...
//            // * Free *
//            if ((rightY < freeThreshold || mouseWheel < 0f) && System.Math.Round(followXform.Speed, 2) == 0)
//            {
...
//                if (follow.currFrameMovespeed > 0.001f)
//                {
...
//                followXform.transform.rotation = (followXform.transform.rotation * deltaRotation);
...
//        Vector3 camPosCache = m_Camera.transform.position;
//        m_Camera.transform.position = toTarget;
//        viewFrustum = DebugDraw.CalculateViewFrustum(m_Camera, ref nearClipDimensions);
...
//        m_Camera.transform.position = camPosCache;
//        viewFrustum = DebugDraw.CalculateViewFrustum(m_Camera, ref nearClipDimensions);
//    }
